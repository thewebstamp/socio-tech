...
function CreatePost({ fetchPosts }) {
    ...
    return (
        ...
        <div ref={createPostContRef} className='flex justify-center items-center [@media(max-width:680px)]:items-end [@media(max-width:680px)]:justify-end fixed z-30 w-full h-screen bg-[#dcdcdcd6] dark:bg-[#323232cd] left-0 top-0'>
            <div ref={createPostRef} className='josefin bg-white px-4 pb-7 [@media(max-width:680px)]:pb-[80px] w-full max-w-[550px] max-h-[70vh] [@media(max-width:680px)]:max-h-[80vh] overflow-y-auto bg-white dark:bg-black shadow-xl rounded-xl'>
                ...
                <div className='flex gap-3 items-center'>
                    <img className='w-[40px] h-[40px] rounded-full' src={`${user.profile_picture}`} alt="" />
                    <span>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='flex justify-between gap-5 px-2'>
                        ...
                        <button className='flex justify-center items-center h-[fit-content] cursor-pointer shadow-xl fredoka rounded-lg px-5 py-[5px] font-medium tracking-[0.3px] text-white bg-[#099ec3]' type="submit">
                            {
                                loading ? (
