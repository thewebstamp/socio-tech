...
function NavPopLC() {
    ...
    return (
        <div className="w-full flex flex-col gap-3 josefin py-4 rounded-2xl shadow-lg bg-white dark:bg-black border border-[rgb(184,184,184)]">
            ...
            <div onClick={() => {switschSDash(); logout()}} className="text-center px-3 pr-5 py-2 mx-4 rounded-xl tracking-wide text-[17.5px] text-white fredoka bg-[#9d0e0e] cursor-pointer shadow">Logout</div>
        </div>
    )
}
