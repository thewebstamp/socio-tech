    ...
    return (
        <div className='josefin bg-white dark:bg-black mt-2 [@media(max-width:800px)]:mt-[-10px]'>
            <div className='relative'>
                <div>
                    <img className='w-full h-[210px] object-cover object-center' src={`http://localhost:1800/uploads/${userp.cover_photo}`} alt="" />
                    {
                        id == userId &&
                        <>
                ...
                <div className='absolute bottom-[-35px] [@media(max-width:680px)]:bottom-[-27.5px] left-4'>
                    <div className='relative'>
                        ...
                        <img className='border-4 border-white dark:border-black rounded-full w-[70px] h-[70px] [@media(max-width:680px)]:w-[55px] [@media(max-width:680px)]:h-[55px] rouned-full object-cover object-center' src={`http://localhost:1800/uploads/${userp.profile_picture}`} alt="" />
